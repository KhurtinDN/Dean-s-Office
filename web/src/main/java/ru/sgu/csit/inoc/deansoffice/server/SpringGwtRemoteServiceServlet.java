package ru.sgu.csit.inoc.deansoffice.server;
...
/**
 * The class SpringGwtRemoteServiceServlet has been wrote Dustin Mallory.
 * Host: http://code.google.com/p/spring4gwt/
 *
...
public class SpringGwtRemoteServiceServlet extends RemoteServiceServlet {
	 ...
	 *
	 * @param request
     *          this is instance HttpServletRequest
	 * @return handler bean
	 */
